 ...
 */
package io.github.ssy.uid.template.baidu.buffer;

import io.github.ssy.uid.template.baidu.utils.PaddedAtomicLong;
 ...
 *
 * A ring buffer is consisted of: <li><b>slots:</b> each element of the array is a slot, which is be
 * set with a UID <li><b>flags:</b> flag array corresponding the same index with the slots,
 * indicates whether can take or put slot <li><b>tail:</b> a sequence of the max slot position to
 * produce <li><b>cursor:</b> a sequence of the min slot position to consume
 *
 * @author yutianbao
 */
