package io.github.ssy.uid.template.leaf.snowflake;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.google.common.collect.Maps;
import io.github.ssy.uid.template.leaf.common.PropertyFactory;
import io.github.ssy.uid.template.leaf.snowflake.exception.CheckLastTimeException;
import java.io.File;
...
public class SnowflakeZookeeperHolder {
  ...
  private static final String PREFIX_ZK_PATH =
    "/snowflake/" + PropertyFactory.getProperties().getProperty("leaf.name");
  private static final String PROP_PATH =
    System.getProperty("java.io.tmpdir") + File.separator + PropertyFactory.getProperties()
      .getProperty("leaf.name") + "/leafconf/{port}/workerID.properties";
  ...
  private void updateLocalWorkerID(int workerID) {
    ...
    if (exists) {
      ...
      try {
        ...
        LOGGER.info("init local file cache create parent dis status is {}, worker id is {}", mkdirs,
          workerID);
        if (mkdirs) {
